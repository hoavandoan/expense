    ...
    <View className="flex-1 bg-background">
      <ScreenScrollView className="pt-4">
        ...
        <View className="mb-12">
          ...
          <Card
            variant="default"
            className="rounded-2xl overflow-hidden border border-divider/10 bg-surface-secondary/50"
          >
            <View className="flex-row items-center p-4">
              ...
              <View className="flex-1">
                ...
                <AppText className="text-accent text-[10px] font-bold uppercase tracking-tighter">
                  Chủ sở hữu
                </AppText>
              </View>
            </View>

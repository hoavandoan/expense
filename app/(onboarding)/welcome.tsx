...
export default function WelcomeScreen() {
  ...
  return (
    <View className="flex-1 bg-background items-center justify-between py-12 px-6">
      <View style={{ paddingTop: insets.top }} className="w-full flex-row justify-between items-center">
      ...
      <View className="w-full gap-4" style={{ marginBottom: insets.bottom }}>
        ...
        >
          <View className="flex-row items-center gap-2">
            <AppText className="font-bold text-lg text-white">Khám phá ngay</AppText>
